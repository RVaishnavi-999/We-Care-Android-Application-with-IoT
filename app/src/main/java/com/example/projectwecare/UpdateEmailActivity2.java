...
public class UpdateEmailActivity2 extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed ();
        startActivity (new Intent (UpdateEmailActivity2.this, GenPhy_DrHomepg.class));
        finish ();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.activity_update_email2);
        ...
        btnUpdateEmail.setEnabled (false); etNewEmail.setEnabled (false);
    ...
    {
        GenPhy_DrHomepg.redirectActivity(this, EditProfile2.class);
    }
        ...
        btnVerifyDr.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty (drPwd)) {
                    ...
                    Toast.makeText (UpdateEmailActivity2.this, "Password is needed to continue !", Toast.LENGTH_SHORT).show ();
                    ...
                    firebaseUser.reauthenticate (credential).addOnCompleteListener (new OnCompleteListener<Void> () {
                        ...
                        public void onComplete(@NonNull Task<Void> task)
                        {
                            if (task.isSuccessful ())
                            {
                                ...
                                Toast.makeText (UpdateEmailActivity2.this, "Password has been verified. You can update email now.", Toast.LENGTH_LONG).show ();
                                ...
                                btnUpdateEmail.setBackgroundTintList (ContextCompat.getColorStateList (UpdateEmailActivity2.this, R.color.dark_green));
                                ...
                                btnUpdateEmail.setOnClickListener (new View.OnClickListener () {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        if (TextUtils.isEmpty (drNewEmail)) {
                                            Toast.makeText (UpdateEmailActivity2.this, "New email is required !", Toast.LENGTH_SHORT).show ();
                                            ...
                                            Toast.makeText (UpdateEmailActivity2.this, "Please enter valid email !", Toast.LENGTH_SHORT).show ();
                                            etNewEmail.setError ("Please enter valid Email Address");
                                            etNewEmail.requestFocus ();
                                        }
                                        else if (drOldEmail.matches (drNewEmail)) {
                                            Toast.makeText (UpdateEmailActivity2.this, "New email cannot be same as old email  !", Toast.LENGTH_SHORT).show ();
                                            etNewEmail.setError ("Please enter new Email Address");
                                            etNewEmail.requestFocus ();
                                        }
                                        else {
                            ...
                            else
                            {
                                try {
                                    ...
                                    Toast.makeText (UpdateEmailActivity2.this, e.getMessage (), Toast.LENGTH_SHORT).show ();
                                }
                            }
        ...
        firebaseUser.updateEmail (drNewEmail).addOnCompleteListener (new OnCompleteListener<Void> () {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                else
                {
                    ...
                    {
                        Toast.makeText (UpdateEmailActivity2.this, e.getMessage (), Toast.LENGTH_LONG).show ();
                    }
                }
                progressBar.setVisibility (View.GONE);
            }
    ...
    private void showsuccess(String title1,String message1,String action1){
        ...
        action.setOnClickListener(v -> {
            Intent i = new Intent (UpdateEmailActivity2.this, GenPhy_DrHomepg.class);
            startActivity (i);
            finish();
            alertDialog.dismiss();
        });
