...
public class UserActivity1 extends BaseActivity implements UserListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textErrorMessage = findViewById(R.id.textErrorMessage1);
                    ...
                    if(task.isSuccessful() && task.getResult() != null){
                        ...
                        for(QueryDocumentSnapshot queryDocumentSnapshot : task.getResult()){
                            ...
                            if(currentUserId.equals(queryDocumentSnapshot.getId())){
                                continue;
                            }else if(design != null && design.equalsIgnoreCase("Senior Doctor") || design.equalsIgnoreCase("Nurse")){
