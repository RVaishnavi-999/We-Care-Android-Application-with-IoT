...
public class ForgotPWD extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed ();
        startActivity (new Intent (ForgotPWD.this, DoctorLogin.class));
        finish ();
    }
        ...
        btn_reset_pwd.setOnClickListener (new View.OnClickListener () {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty (email)) {
                    Toast.makeText (ForgotPWD.this, "Please enter your registered email !", Toast.LENGTH_SHORT).show ();
        ...
        authProfile.sendPasswordResetEmail (email).addOnCompleteListener (new OnCompleteListener<Void> () {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful ()) {
                    Toast.makeText (ForgotPWD.this, "Please check your inbox for password reset link", Toast.LENGTH_SHORT).show ();

                    Intent i = new Intent (ForgotPWD.this, DoctorLogin.class);
