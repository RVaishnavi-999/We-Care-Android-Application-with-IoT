...
public class chatDR extends BaseActivity implements ConversationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageProfile = findViewById(R.id.imageProfile2);
        textName = findViewById(R.id.textName2);
        conversationRecyclerview = findViewById(R.id.conversationRecyclerview2);
        progressBar = findViewById(R.id.progressBar13);
        fabnewchat = findViewById(R.id.fabnewchat2);
    ...
    private void setListeners() {
        fabnewchat.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(),UserActivity2.class)));
    }
