...
public class MainActivityNurse extends BaseActivity implements ConversationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mainnurse);
    ...
    private void setListeners() {
        fabnewchat.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(),UserActivity.class)));
    }
